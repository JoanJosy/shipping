        ...
        <div class="menu_block">
            <nav>
                <ul class="sf-menu">
                    ...
                    <li class="current"><a href="ship.php">Ship</a>
                        <ul>
                    ...
                    <div class="grid_4 alpha">
                        <div class="tour"> <img src="./mainadminhome/upload/<?php echo $row["image"]?>" alt="" class="img_inner fleft">
                            <div class="extra_wrapper">
                                <p class="text1"><?php echo $row['ship_name'];?> </p>
                                <p class="price">Max Passangers:<?php echo $row['cargo_capacity'];?>  </p>
                                <p class="price">Price per Person:<?php echo $row['cargo_amount'];?> </p>


                                <a href="shipdetails.php?edit=1&id=<?php echo $row['ship_id'];?>" class="btn">Details</a> </div><br>
                            <br>
